  ...
  return <main data-theme={theme}>
    ...
    <section className="contact" id="contact">
      ...
      <div className="contact-inner">
        <Reveal><p className="kicker">Let’s build what’s next</p><h2>Let’s build<br /><em>what’s next.</em></h2><p>Bring us your idea. We will help you turn it into a real product with measurable impact.</p><div className="direct-contact"><a href="mailto:Nexa.infotech@gmail.com"><span>Email</span><strong>Nexa.infotech@gmail.com</strong></a><a href="tel:+918978279915"><span>Phone</span><strong>+91 89782 79915</strong></a></div></Reveal>
